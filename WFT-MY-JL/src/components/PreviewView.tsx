...
export const PreviewView: React.FC<PreviewViewProps> = ({ project }) => {
  ...
  const handleDataChange = (category: string, field: string, value: number | boolean) => {
    if (category === 'time') {
      setSimulationData(prev => ({
        ...prev,
        time: {
            ...
            <div className="control-section">
              ...
              <div className="control-row">
                ...
                <input
                  ...
                  onChange={(e) => handleDataChange('', 'showNoData', e.target.checked)}
          ...
          <div className="watch-canvas">
            {project.components.map(component => {
              ...
              if (component.type === 'analog') {
                ...
                const originY = component.config.originPointY || 233;
