...
interface ComponentLibraryProps {
  ...
  onAddSeparatorComponent: (separatorType: 'time' | 'date') => void;
}
    ...
    return (
      <div className="component-library">
        ...
        <div className="component-list">
          ...
          <div className="component-section-divider">Date & Time Extras</div>
          ...
          <button className="component-list-item" onClick={() => { onAddSeparatorComponent('time'); setShowComponentList(false); }}>
            <Clock size={20} />
            <span>Time Separator (:)</span>
          </button>
          
          <button className="component-list-item" onClick={() => { onAddSeparatorComponent('date'); setShowComponentList(false); }}>
            <Calendar size={20} />
